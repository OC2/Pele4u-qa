...
$scope.doRefresh();
    ...
    $scope.doRefresh = function() {
      ...
      PelApi.writeToLog(appSettings.config.LOG_FILE_INFO_TYPE ,"IN p2_scan_printCtrl.scanBarcode();");
      ...
      if(window.cordova != undefined){
        ...
        .then(function(imageData) {
          ...
          if(res) {
            ...
            sendScanPrint.then(
              ...
              , function (response) {
                ...
                PelApi.writeToLog(appSettings.config.LOG_FILE_ERROR_TYPE, " 1 . p2_scan_printCtrl.scanBarcode() - " + JSON.stringify(response));
          ...
          PelApi.writeToLog(appSettings.config.LOG_FILE_ERROR_TYPE ," 2 . p2_scan_printCtrl.scanBarcode() - " + JSON.stringify(error));
