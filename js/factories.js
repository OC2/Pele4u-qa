...
.factory('PelApi',function($http
  ...
  return {
    ...
    getfull_SETTINGS_DIRECTORY_NAME : function() {
      ...
      if ("win32" !== platform) {
        retVal = cordova.file.externalApplicationStorageDirectory + config_app.SETTINGS_DIRECTORY_NAME;
      }
      return retVal;
    },
    getfull_ATTACHMENT_DIRECTORY_NAME : function() {
      ...
      var platform = ionic.Platform.platform();
      if ("win32" !== platform) {
        retVal = cordova.file.externalApplicationStorageDirectory + config_app.ATTACHMENT_DIRECTORY_NAME;
      }
      return retVal;
    },
    setPELE4_ATTACHMENT_DIRECTORY : function(){
      ...
      if ("win32" !== platform) {
        ...
        $cordovaFile.checkDir(cordova.file.externalApplicationStorageDirectory, config_app.ATTACHMENT_DIRECTORY_NAME)
          .then(function (success) {
            ...
            if (error.message === "NOT_FOUND_ERR") {
              $cordovaFile.createDir(cordova.file.externalApplicationStorageDirectory, config_app.ATTACHMENT_DIRECTORY_NAME, true)
                .then(function (success) {
                  // success
    ...
    setPELE4_SETTINGS_DIRECTORY : function(){
      ...
      var platform = ionic.Platform.platform();
      if ("win32" !== platform) {
        $cordovaFile.checkDir(cordova.file.externalApplicationStorageDirectory, config_app.SETTINGS_DIRECTORY_NAME)
          .then(function (success) {
            // success
            console.log("SUCCESS : " + success);
          }, function (error) {
            // error
            if (error.message === "NOT_FOUND_ERR") {
              $cordovaFile.createDir(cordova.file.externalApplicationStorageDirectory, config_app.SETTINGS_DIRECTORY_NAME, false)
                .then(function (success) {
                  // success
                  console.log("$cordovaFile.createDir SUCCESS : " + success);
                }, function (error) {
    ...
    delete_ATTACHMENT_DIRECTORY_NAME : function(){
      ...
      if ("win32" !== platform) {
        $cordovaFile.checkDir(cordova.file.externalApplicationStorageDirectory, config_app.ATTACHMENT_DIRECTORY_NAME)
          .then(function (success) {
            // success
            var filePath = cordova.file.externalApplicationStorageDirectory + config_app.ATTACHMENT_DIRECTORY_NAME;

            $cordovaFile.removeRecursively(cordova.file.externalApplicationStorageDirectory , config_app.ATTACHMENT_DIRECTORY_NAME )
              .then(function (success) {
                // success
                console.log("$cordovaFile.removeRecursively SUCCESS : " + success);
                $cordovaFile.createDir(cordova.file.externalApplicationStorageDirectory, config_app.SETTINGS_DIRECTORY_NAME, false)
                  .then(function (success) {
                    // success
                    console.log("$cordovaFile.createDir SUCCESS : " + success);
