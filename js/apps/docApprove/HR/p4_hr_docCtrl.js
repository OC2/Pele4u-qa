 ...
 */
var app = angular.module('pele.p4_hr_docCtrl', ['ngStorage']);
//=================================================================
//==                    PAGE_4
//=================================================================
app.controller('p4_hr_docCtrl',['$rootScope'
  ,'$scope'
  ,'$stateParams'
  ,'$http'
  ,'$q'
        ...
        if(res){
          ...
          myPopup.then(function (res) {
            if(!res.cancel) {
              ...
              retSubmitNotification.then(
                ...
                //---- ERROR -----//
                function (responce) {
                    PelApi.writeToLog(config_app.LOG_FILE_ERROR_TYPE , "SubmitNotif : " + JSON.stringify(responce));
          ...
          retSubmitNotification.then(
            ...
            function (response) {
                ...
                PelApi.writeToLog(config_app.LOG_FILE_ERROR_TYPE , "SubmitNotif : " + JSON.stringify(response));
                $ionicLoading.hide();
                $scope.$broadcast('scroll.refreshComplete');
                $ionicNavBarDelegate.back();
            }
